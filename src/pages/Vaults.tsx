...
export default function Vaults() {
    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row gap-6 mt-[50px]">
            ...
            <img src={Dew1} className="absolute top-[50vh] left-[-80px] w-[30px] dew-float" />
            <img src={Dew2} className="absolute top-[90vh] right-[-40px] w-[10px] dew-float2" />
            <img src={Dew3} className="absolute bottom-[10vh] right-[-40px] w-[10px] dew-float3" />
                                        ...
                                        <div className="bg-card-background rounded-sm p-4 px-5 space-y-2">
                                            <div className="flex justify-between text-sm">
                                                ...
                                                <div className='flex gap-1.5 items-center justify-center'>
                                                    <span>0.001</span> <img src={Near} alt={'NEAR'} className="w-4 h-4" />
                                                    <ArrowLeftRight className="text-gray" size={12} />
                                                    <span>1.03</span> <img src={Btc} alt={'USDT'} className="w-4 h-4" />
                                                </div>
                                            </div>
                                            <div className="flex justify-between text-sm">
