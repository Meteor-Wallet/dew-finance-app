                ...
                <div className="space-y-4 mt-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-20">
                    {policies.map((policy, i) => {
                        return (
                            <div
                                key={i}
                                className="bg-[linear-gradient(139deg,#000000,#181822)] p-5 pb-[70px] rounded-md relative border border-dark-border-color w-full h-full mx-auto"
                            >
                                ...
                                <div className="text-sm flex gap-2 flex-col">
                                    ...
                                    <div className='flex justify-between items-center w-full'>
                                        ...
                                        <p className='text-right'>{policy.policy_details.ChainSigTransaction.restrictions.length}</p>
                                    </div>
                                </div>
