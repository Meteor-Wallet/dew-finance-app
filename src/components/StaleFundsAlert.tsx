...
import WithdrawStaleFundsModal from "./modal/WithdrawStaleFundsModal";
...
export default function StaleFundsAlert() {
  ...
  return (
    <>
      ...
      <WithdrawStaleFundsModal isOpen={modalOpen} onClose={() => setModalOpen(false)} />
    </>
  );
}
